...
class UpdatePromoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'delete_banner_ids' => ['nullable', 'array'],
            'delete_banner_ids.*' => ['nullable', 'integer'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'delete_banner_ids.array' => 'Format banner promo yang dihapus harus berupa array.',
            'delete_banner_ids.*.integer' => 'ID banner promo yang dihapus harus berupa angka.',
        ];
    }

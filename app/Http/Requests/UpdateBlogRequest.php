...
class UpdateBlogRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'blog_content.string' => 'Konten blog harus berupa string.',
            'delete_thumbnail_ids.array' => 'Format thumbnail yang dihapus harus berupa array.',
            'delete_thumbnail_ids.*.integer' => 'ID thumbnail yang dihapus harus berupa angka.',
        ];
    }
